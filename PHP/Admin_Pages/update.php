...
$update="update sports set id='$user_id_change',fullname='$fullname',email_id='$email',phonenumber='$phonenumber',password='$password',gender='$gender',dob='$dob',languages='$languages',photo='$fileuploadings' where id='$idd'";
