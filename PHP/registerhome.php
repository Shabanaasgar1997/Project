...
<?php
session_start();
error_reporting('registerhome.php');
...
<!-- Carousel Starts Here -->
   ...
   <div class="carousel-inner sports_pictures_carousel">
    <div class="carousel-item active">
      <img src="../IMAGES/sports1.jpg" class="d-block" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../IMAGES/sports2.jpg" class="d-block" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../IMAGES/sports3.jpg" class="d-block" alt="...">
    </div>
	 <div class="carousel-item">
      <img src="../IMAGES/sports4.jpg" class="d-block" alt="...">
    </div>
	 <div class="carousel-item">
      <img src="../IMAGES/sports5.jpg" class="d-block" alt="...">
	</div>
...
<button class="btn btn-danger p-3" style="color:white;">SCORE BOARD</button>
</div>
</div>
...
<div class="row" style="padding:100px;display:flex;">
	<div class="col-4"><img src="../IMAGES/logo01.png" alt="" width="80"/></div>
...
<div class="col-lg-3">
  ...
  <a class="carousel-control-prev" href="#latest_Slide" role="button" data-slide="prev">
  <i class="fas fa-chevron-left fa-5x"></i>
  </a>
  <a class="carousel-control-next" href="#latest_Slide" role="button" data-slide="next">
